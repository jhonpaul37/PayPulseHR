...
const AccountingEntry = ({
    ...
    return (
        <div>
            <div className="border-b border-black p-2 text-xs">B. Accounting Entry {amount}</div>
            <div>
                <div className="grid grid-cols-4 border-b border-black text-xs">
                    <div className="flex items-center justify-center">Account Title</div>
                ...
                <div className="flex flex-col justify-center border-b border-black">
                    {entries.map((entry, index) => (
                        <div key={index} className="grid grid-cols-4 border-b border-black">
                                ...
                                <div className="relative w-full">
                                    <input
                                        ...
                                        className={`focus:shadow-outline w-full appearance-none rounded border px-3 py-2 leading-tight shadow focus:outline-none ${
                                            !entry.query && !errors.uacs_code
                                                ? 'border-high'
                                                : errors.uacs_code
                                                  ? 'border-red-500'
                                                  : 'border-gray-300'
                                        }`}
                                        placeholder="Type to search Account Title"
                                        autoComplete="off"
                                    />
